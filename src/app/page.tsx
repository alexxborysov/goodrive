...
export default function Home() {
  return (
    <main className="mt-[61px] flex h-full w-full flex-col items-center justify-items-center font-[family-name:var(--font-geist-sans)]">
      <section className="-mt-[13vh] flex h-screen flex-col items-center justify-center gap-[32px] px-5 sm:items-start md:px-2">
        <h1
      ...
      <section
        id="charts"
        className="from-0 -mt-20 flex w-full items-stretch justify-center from-[#09090B] from-15% via-[#151719] via-45% to-[#09090B] to-99% px-2 pt-40 pb-36 md:px-3 xl:px-6 dark:bg-gradient-to-b"
      >
